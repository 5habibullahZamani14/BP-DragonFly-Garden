...
if command -v xdg-open > /dev/null; then
    xdg-open http://localhost:5173/?qr=payment-counter-1
elif command -v open > /dev/null; then
    open http://localhost:5173/?qr=payment-counter-1
else
    echo "Please open http://localhost:5173/?qr=payment-counter-1 in your browser"
fi
