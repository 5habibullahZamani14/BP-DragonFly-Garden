 ...
 * introduction — the logo image, the cafe name with italic accent
...
export const LandingView = () => {
  ...
  return (
    <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 py-12 text-center">
      {/* Hero logo image — the main brand visual */}
      <img
        src={bpDragonflyGardenLogo}
        alt="BP Dragonfly Garden logo"
        className="mb-6 h-56 w-72 object-contain drop-shadow-[0_18px_30px_rgba(0,0,0,0.18)]"
      />

      <span className="eyebrow">{t("landing.welcome")}</span>
      <h1 className="mt-3 font-1 text-[3rem] font-bold leading-[0.92] tracking-tight text-balance">
      ...
      <div className="relative mt-10 w-full max-w-sm">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="font-1 text-2xl font-bold">{t("landing.scan")}</h2>
