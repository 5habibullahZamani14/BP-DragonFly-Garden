...
import { Grid3X3, Plus, QrCode } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {tables.map((table) => (
          <Card key={table.id} className="text-center hover:shadow-md transition-shadow cursor-pointer border-t-4 border-t-green-500">
