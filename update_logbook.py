...
# Define the July section with detailed entries based on actual git diffs
...
# Find and replace the July section
old_july_start = content.find("| 30 Jun 2026 | Tuesday | Code Review")
if old_july_start > 0:
    old_july_end = content.find("## Upcoming", old_july_start)
    if old_july_end > 0:
        # Replace the old July section
        content = content[:old_july_start-24] + july_section + "\n\n" + content[old_july_end:]
    
# Write back with proper encoding
with open('LOGBOOK-LatestUpdateOn-May15th.md', 'w', encoding='utf-8') as f:
    f.write(content)

print("Logbook updated successfully with detailed July entries based on git analysis!")
